...
function AuthRegister() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      {/* Form Overlay */}
      <div className="md:mt-28 relative z-20 min-h-screen md:h-screen md:overflow-hidden flex items-center justify-center p-4">
        <div className="w-full max-w-2xl">

          {/* Form Container - Glass effect to show model clearly */}
          <div className="bg-white/5 backdrop-blur-[2px] rounded-2xl p-8 shadow-sm border border-white/10 md:max-h-[80vh] md:overflow-hidden">
